export default {
  ...
  an_error_was_generated_while_trying_to_delete_the_record: 'Se ha generado un error al intentar eliminar el registro..',
  save_success: 'Guardado satisfactorio.',
